    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="flex items-center justify-center px-6 py-16">
        <div className="w-full max-w-md rounded-3xl bg-white p-8 shadow-lg">
          ...
          <p className="mb-6 text-sm text-slate-600">Log in to manage your bookings.</p>
          ...
          <form className="space-y-4">
            ...
            <div>
              ...
              <input type="password" className="w-full rounded-xl border border-slate-300 px-4 py-3 outline-none focus:border-cyan-500" placeholder="••••••••" />
            </div>
          ...
          <div className="mt-4 flex items-center justify-between text-sm">
            ...
            <Link to="/signup" className="text-cyan-600 hover:underline">Don’t have an account?</Link>
          </div>
          <Link to="/" className="mt-6 inline-block text-sm text-slate-500 hover:text-cyan-600">
            ← Back home
          </Link>
        </div>
      </div>
